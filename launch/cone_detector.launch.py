...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            launch.actions.DeclareLaunchArgument(name="model_path", default_value=model_path),
            ...
            Node(
                ...
                parameters=[
                    ...
                    {"lidar_topic": launch.substitutions.LaunchConfiguration("lidar_topic")},
                    ...
                    {"lidar_frame_id": launch.substitutions.LaunchConfiguration("lidar_frame_id")},
